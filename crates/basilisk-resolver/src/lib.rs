...
pub use scope::{
    ...
    ModuleBareAssignment, ModuleBindings, ModuleOrderComparisonInfo, Named, NamedTupleDefInfo,
    NarrowingGuard, NarrowingGuardKind, NewTypeCallInfo, PackageDepKind, ParameterInfo,
    Pep695AliasDef, Pep695BoundViolation, Pep695BoundViolationKind, Pep695Def, Pep695Param,
    Pep695ParamKind, Pep695Scoping, ProtocolClassObjectViolation, ProtocolInstantiationViolation,

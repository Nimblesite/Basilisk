...
fn known_attrs_for_type(type_name: &str) -> Option<&'static [&'static str]> {
    match type_name {
        "str" => Some(&[
            ...
            "__add__", "__contains__", "__eq__", "__ge__", "__getitem__",
            "__gt__", "__hash__", "__iter__", "__le__", "__len__", "__lt__",
            "__mod__", "__mul__", "__ne__", "__repr__", "__rmul__", "__str__",
        ]),
        "int" => Some(&[
            "bit_length", "bit_count", "to_bytes", "from_bytes", "as_integer_ratio",
            "is_integer", "conjugate", "denominator", "imag", "numerator", "real",
            "__abs__", "__add__", "__and__", "__bool__", "__ceil__", "__divmod__",
            "__eq__", "__float__", "__floor__", "__floordiv__", "__ge__", "__gt__",
            "__hash__", "__index__", "__int__", "__invert__", "__le__", "__lshift__",
        ...
        "float" => Some(&[
            ...
            "is_integer", "real",
            "__abs__", "__add__", "__bool__", "__ceil__", "__divmod__", "__eq__",
            "__float__", "__floor__", "__floordiv__", "__ge__", "__gt__",
            "__hash__", "__int__", "__le__", "__lt__", "__mod__", "__mul__",
            "__ne__", "__neg__", "__pos__", "__pow__", "__radd__", "__rdivmod__",
            "__repr__", "__rfloordiv__", "__rmod__", "__rmul__", "__round__",
            "__rpow__", "__rsub__", "__rtruediv__", "__str__", "__sub__",
        ...
        "list" => Some(&[
            ...
            "__le__", "__len__", "__lt__", "__mul__", "__ne__", "__repr__",
            "__reversed__", "__rmul__", "__setitem__", "__str__",
        ]),
        "dict" => Some(&[
            "clear", "copy", "fromkeys", "get", "items", "keys", "pop",
            "popitem", "setdefault", "update", "values",
            "__contains__", "__delitem__", "__eq__", "__ge__", "__getitem__",
            "__gt__", "__iter__", "__le__", "__len__", "__lt__", "__ne__",
            "__or__", "__repr__", "__reversed__", "__ror__", "__setitem__",
            "__str__",
        ]),
        _ => None,
    }
...
pub(crate) fn collect(stmts: &[Stmt]) -> Vec<BoundedTypeVarAttrViolation> {
    ...
    for stmt in stmts {
        ...
        let Some(type_params) = &cls.type_params else { continue };
        ...
        if typevar_bounds.is_empty() { continue }
        for body_stmt in &cls.body {
            ...
            let mut param_typevar: std::collections::HashMap<String, String> =
                std::collections::HashMap::new();
            for param in func.parameters.as_ref().args.iter()
            ...
            if param_typevar.is_empty() { continue }

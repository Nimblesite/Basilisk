//! String-parsing and annotation-validity helpers for BSK-E0047.
//!
//! Contains all pure functions for detecting invalid type expressions
//! by examining annotation text (as a string slice), plus the builtin
//! type name list.

...
pub(super) const ORIGIN_REJECTED: &str = r"
from typing import get_origin

sluice: str = get_origin(list[int])
";

pub(super) const ORIGIN_ACCEPTED: &str = r"
from typing import get_origin

sluice: type = get_origin(list[int])
";

pub(super) const ORIGIN_REJECTED_ALIASED: &str = r"
from typing import get_origin as origin_of

sluice: str = origin_of(list[int])
";

pub(super) const ORIGIN_REJECTED_IMPORT_FORM: &str = r"
import typing
...
pub(super) const ARGS_REJECTED: &str = r"
from typing import get_args

grommet: int = get_args(dict[str, int])
";

pub(super) const ARGS_ACCEPTED: &str = r"
from typing import get_args

grommet: tuple[object, ...] = get_args(dict[str, int])
";

pub(super) const ARGS_REJECTED_ALIASED: &str = r"
from typing import get_args as args_of

grommet: int = args_of(dict[str, int])
";

pub(super) const ARGS_REJECTED_RENAMED: &str = r"
from typing import get_args
...
pub(super) const HINTS_REJECTED: &str = r"
...
pub(super) const HINTS_ACCEPTED: &str = r"
from typing import get_type_hints
...
pub(super) const HINTS_ACCEPTED_IMPORT_FORM: &str = r"
import typing
...
pub(super) const TYPEDDICT_REJECTED: &str = r"
...
pub(super) const TYPEDDICT_ACCEPTED: &str = r"
from typing import TypedDict as RecordShape, is_typeddict
...
pub(super) const TYPEDDICT_ACCEPTED_IMPORT_FORM: &str = r"
import typing
...
pub(super) const ANYSTR_REJECTED: &str = r#"
...
pub(super) const ANYSTR_ACCEPTED: &str = r#"
from typing import AnyStr
...
pub(super) const ANYSTR_REJECTED_ALIASED: &str = r#"
...
pub(super) const ANYSTR_REJECTED_REFORMATTED: &str = "
from typing import AnyStr
...
pub(super) const DEQUE_REJECTED: &str = r"
...
pub(super) const DEQUE_ACCEPTED: &str = r"
from typing import Deque
...
pub(super) const DEQUE_REJECTED_RENAMED: &str = r"
from typing import Deque
...
pub(super) const DEQUE_ACCEPTED_IMPORT_FORM: &str = r"
import collections

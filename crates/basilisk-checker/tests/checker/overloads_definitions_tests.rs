//! Tests for [`overloads_definitions`] from [CHKARCH-DIAG-TYPESAFETY] / [TYPEINF-FUNC-OVERLOADS]. See docs/specs/CHECKER-ARCHITECTURE-SPEC.md#CHKARCH-DIAG-TYPESAFETY

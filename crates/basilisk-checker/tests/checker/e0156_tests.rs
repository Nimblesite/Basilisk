//! Tests for [BSK-E0156] from [CHKARCH-DIAG-TYPEDDICT-EXTRA-ITEMS]. See docs/specs/CHECKER-ARCHITECTURE-SPEC.md#CHKARCH-DIAG-TYPEDDICT-EXTRA-ITEMS
...
fn e0156_closed_inherited_extra_key_fires() -> Result<(), Box<dyn std::error::Error>> {
    ...
    assert!(
        codes(&diags).contains(&"BSK-E0156"),

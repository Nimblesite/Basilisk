# Remaining Conformance FP Notes (for B2's e0014/e0093 lane) {#FPNOTES}
...
## 1. literals_semantics.py:39 — assignment_compatibility (EASIEST, 1 FP) {#FPNOTES-LITERALS-SEMANTICS}
...
## 2. typeddicts_readonly_update.py:34 — typeddicts_operations (ONE-LINER, 1 FP) {#FPNOTES-TYPEDDICTS-READONLY-UPDATE}
...
## 3. typeddicts_readonly_consistency.py:34,35,41,78,79 — assignment_compatibility (CAREFUL, 5 FPs) {#FPNOTES-TYPEDDICTS-READONLY-CONSISTENCY}
...
## 4. aliases_recursive.py:61,62,67,68 — assignment_compatibility (HARDEST, 4 FPs) {#FPNOTES-ALIASES-RECURSIVE}
...
### Status {#FPNOTES-ALIASES-RECURSIVE-STATUS}

...
- [x] **Phase 5: Wire Into Rules** (~10 FPs) — DONE
  ...
  - [x] 5d. Full conformance suite verification — the "**18 FPs** (target < 71)" result came from a rigged in-repo harness and is FALSE; the official `python/typing` scorer reports **219 false positives** (70/146 files passing, 47.9% errors-only). Driving FPs down remains active work.

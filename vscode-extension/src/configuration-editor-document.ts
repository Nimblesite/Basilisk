...
const ADOPTION_SECTION = `
  <section id="adoption-section" data-section="adoption" aria-labelledby="adoption-title" hidden>
    ...
    <div id="adoption-grid">
      ...
      <article class="card" data-accent="sky"><h3>2 · Take the free wins</h3><p>Presets may calculate safe fixes together with policy before anything is written.</p><button type="button" class="secondary" data-section-target="overview">Review policy presets</button></article>

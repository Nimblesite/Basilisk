...
| --- | --- |
| ⚡ **Basilisk** | **<!--g:benchBasilisk-->16<!--/g:benchBasilisk--> ms** |
| zuban | <!--g:benchZuban-->37<!--/g:benchZuban--> ms |
| ty | <!--g:benchTy-->48<!--/g:benchTy--> ms |
| Pyrefly | <!--g:benchPyrefly-->139<!--/g:benchPyrefly--> ms |
| Pyright | <!--g:benchPyright-->751<!--/g:benchPyright--> ms |
| mypy | <!--g:benchMypy-->788<!--/g:benchMypy--> ms |

Median cold full-file check across <!--g:benchCount-->26<!--/g:benchCount--> single-construct typing-spec stress fixtures on an <!--g:benchMachine-->Apple M4 Max<!--/g:benchMachine--> &mdash; lower is better. Basilisk&rsquo;s warm re-check drops to ~<!--g:benchWarm-->6<!--/g:benchWarm--> ms. Every figure is produced by [`hyperfine`](https://github.com/sharkdp/hyperfine) and committed per machine, so nothing here is hand-typed. **Clone the repo, run `make bench` on your own hardware, and send us the CSV &mdash; independent audits are welcome.** [Full benchmarks &amp; methodology &rarr;](https://www.basilisk-python.dev/docs/benchmarks/)

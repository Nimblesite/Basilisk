...
class Factory:
    ...
    @classmethod
    def from_string(cls, text: str) -> "Factory":  # NO W0050 — cls return is not inferrable
        return cls()
...
def apply_func(func: Callable[[int], int], value: int) -> int:  # NO W0050 — Callable needed
    return func(value)
...
@contextmanager
def managed_resource() -> Generator[str, None, None]:  # NO W0050 — Generator type needed
    yield "resource"
